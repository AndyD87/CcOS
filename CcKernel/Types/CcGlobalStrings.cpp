...
CcConstStringClass_C(Line,"-", CcGlobalStrings::Seperators);
CcConstStringClass_C(Underline,"_", CcGlobalStrings::Seperators);
const CcString& CcGlobalStrings::Seperators::Space = CcGlobalStrings::Space;
const CcString& CcGlobalStrings::Seperators::Path = CcGlobalStrings::Seperators::Slash;
const CcString& CcGlobalStrings::Seperators::IpV4 = CcGlobalStrings::Seperators::Dot;
const CcString& CcGlobalStrings::Seperators::MacAddress = CcGlobalStrings::Seperators::Colon;
const CcString& CcGlobalStrings::Seperators::MacAddressMinus = CcGlobalStrings::Seperators::Line;
