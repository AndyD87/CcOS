...
public:
  ...
  CcVector<TYPE>& append(const CcVector<TYPE> &oToAppend)
  {
    m_pVector->insert(m_pVector->end(), oToAppend.m_pVector->begin(), oToAppend.m_pVector->end());
    return *this;
  }
  ...
  CcVector<TYPE>& append(const CcVector<TYPE>& oToAppend, size_t count)
  {
    m_pVector->insert(m_pVector->end(), oToAppend.m_pVector->begin(), oToAppend.m_pVector->begin() + count);
    return *this;
  }
  ...
  CcVector<TYPE>& append(const TYPE& oToAppend)
  {
    m_pVector->push_back(oToAppend);
    return *this;
  }

  CcVector<TYPE>& append(const TYPE* oToAppend, size_t count)
  {
    m_pVector->insert(m_pVector->end(), oToAppend, oToAppend + count);
    return *this;
  }
