 ...
 */
class CcWmiResult : public CcTable
{
public:
  /**
   * @brief Constructor
   */
  CcWmiResult( size_t numCols = 0 );

  /**
   * @brief CopyConstructor
   */
  CcWmiResult(const CcWmiResult& oToCopy);

  /**
   * @brief MoveConstructor
   */
  CcWmiResult(CcWmiResult&& oToMove);
   ...
   */
  CcWmiResult& operator=(CcWmiResult&& oToMove);
   ...
   * @return Handle to this
   */
  CcWmiResult& operator=(const CcWmiResult& oToCopy);
