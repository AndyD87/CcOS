...
/**
 * @page      Windows
 * @subpage   CcWindowsSocket
 *
 * @page      CcWindowsSocket
 ...
 */
#ifndef CcWindowsSocket_H_
#define CcWindowsSocket_H_
...
*/
class CcWindowsSocket : public CcSocketAbstract
{
public:
  /**
  * @brief Constructor
  */
  CcWindowsSocket( ESocketType type = ESocketType::TCP );

  CcWindowsSocket(SOCKET socket, sockaddr sockAddr, int sockAddrlen);
  /**
   * @brief Destructor
   */
  virtual ~CcWindowsSocket( void );
