 ...
 * @brief     Implemtation of class WindowsProcessThread
 */
...
WindowsProcessThread::WindowsProcessThread(CcProcess& rProcess) :
  m_hProcess(&rProcess)
{
}

WindowsProcessThread::~WindowsProcessThread( void )
{
}

void WindowsProcessThread::run()
{
  ...
  si.hStdInput  = static_cast<WindowsPipe&>(m_hProcess->pipe()).m_HandleIn;
  si.hStdOutput = static_cast<WindowsPipe&>(m_hProcess->pipe()).m_HandleOut;
  si.hStdError  = static_cast<WindowsPipe&>(m_hProcess->pipe()).m_HandleOut;
  ...
  else
  {
    ...
    static_cast<WindowsPipe&>(m_hProcess->pipe()).m_HandleIn = INVALID_HANDLE_VALUE;
    static_cast<WindowsPipe&>(m_hProcess->pipe()).m_HandleOut = INVALID_HANDLE_VALUE;
  }
}