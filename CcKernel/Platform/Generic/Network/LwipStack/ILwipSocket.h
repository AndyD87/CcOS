...
public:
  ...
  */
  ...
  virtual SOCKETFD getSocketFD() override { return reinterpret_cast<SOCKETFD>(m_pNetconn); }

protected:
  netconn*            m_pNetconn = nullptr;      //!< ClientSocket generated by InitSocket
