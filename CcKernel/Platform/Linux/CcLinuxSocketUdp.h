 ...
 */
#ifndef CcLinuxSocketUdp_H_
#define CcLinuxSocketUdp_H_
...
public:
  ...
  */
  ...
  CcStatus open(EOpenFlags eFlags = EOpenFlags::NoFlag) override;
   ...
   */
  CcStatus bind(const CcSocketAddressInfo& oAddressInfo) override;
