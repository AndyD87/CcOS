...
private:
  ...
  void writeMap(IIoDevice& rOutput, const CcJsonNode& oItem);
  void writeArray(IIoDevice& rOutput, const CcJsonNode& oItem);
  void writeValue(IIoDevice& rOutput, const CcJsonNode& oItem);
