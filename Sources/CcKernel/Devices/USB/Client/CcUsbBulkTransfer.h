 ...
 */
class CcKernelSHARED CcUsbBulkTransfer : public CcObject, public IIo
{
public:
  /**
   ...
   */
  CcUsbBulkTransfer(const CcDeviceUsbDevice& oInterface);
  virtual ~CcUsbBulkTransfer();
