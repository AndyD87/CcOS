 ...
 * @par       Language: C++11
 * @brief     Implementation of class STM32F207IGSystemGpioPin
 **/
...
{
public:
  STM32F207IGSystemGpioPinPrivate(GPIO_TypeDef* pPort, uint32 uiPinNr) :
    pPort(pPort),
    uiPinNr(uiPinNr)
    {}
  GPIO_TypeDef* pPort;
...
STM32F207IGSystemGpioPin::~STM32F207IGSystemGpioPin()
{
  CCDELETE(m_pPrivate);
}
...
IGpioPin::EDirection STM32F207IGSystemGpioPin::getDirection()
{
