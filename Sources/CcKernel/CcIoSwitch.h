 ...
 */
class CcKernelSHARED CcIoSwitch : public IIo
{
public:
  ...
  void setWriteStream(IIo* pWriteStream)
  { m_pWriteStream = pWriteStream; }
  void setReadStream(IIo* pReadStream)
  { m_pReadStream = pReadStream; }
private:
  IIo* m_pWriteStream = nullptr;
  IIo* m_pReadStream = nullptr;
};
