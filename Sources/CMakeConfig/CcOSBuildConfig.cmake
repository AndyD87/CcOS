...
if(WINDOWS)
  if(CcOS_FIND_COMPONENTS)
    ...
    if(${COMPONENT} STREQUAL "CcConvert")
      set(CCOS_APPS_CCCONVERT_ACTIVE 4)
    endif()
  ...
  if(${CCOS_CCMODULE_ACTIVE} EQUAL 1)
    ...
    if(DEFINED CCOS_APPS_CCCONVERT_ACTIVE)
      if(${CCOS_APPS_CCCONVERT_ACTIVE} GREATER 1)
        set(CCOS_CCMODULE_ACTIVE 2)
      endif(${CCOS_APPS_CCCONVERT_ACTIVE} GREATER 1)
    endif(DEFINED CCOS_APPS_CCCONVERT_ACTIVE)
  ...
  # CcConvert
  ################################################################################
  if(NOT DEFINED CCOS_APPS_CCCONVERT_ACTIVE)
    set(CCOS_APPS_CCCONVERT_ACTIVE 1)
  endif(NOT DEFINED CCOS_APPS_CCCONVERT_ACTIVE)
  if(NOT DEFINED CCOS_APPS_CCCONVERT_VERSION)
    set(CCOS_APPS_CCCONVERT_VERSION 0.0.0.0)
  endif(NOT DEFINED CCOS_APPS_CCCONVERT_VERSION)
  if(NOT DEFINED CCOS_APPS_CCCONVERT_PREBUILD)
    set(CCOS_APPS_CCCONVERT_PREBUILD false)
  endif(NOT DEFINED CCOS_APPS_CCCONVERT_PREBUILD)
  if(NOT DEFINED CCOS_APPS_CCCONVERT_STATIC)
    set(CCOS_APPS_CCCONVERT_STATIC false)
  endif(NOT DEFINED CCOS_APPS_CCCONVERT_STATIC)
  if(NOT DEFINED CCOS_APPS_CCCONVERT_STATICRUNTIME)
    set(CCOS_APPS_CCCONVERT_STATICRUNTIME false)
  endif(NOT DEFINED CCOS_APPS_CCCONVERT_STATICRUNTIME)
  # Check if required because of income dependencies
  if(${CCOS_APPS_CCCONVERT_ACTIVE} EQUAL 1)
  endif(${CCOS_APPS_CCCONVERT_ACTIVE} EQUAL 1)
  # Check if required because of own dependencies
  if(${CCOS_APPS_CCCONVERT_ACTIVE} EQUAL 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message("Disable CcConvert")
      message("Dependency for CcConvert not solved: CcKernel")
      set(CCOS_APPS_CCCONVERT_ACTIVE 0)
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message("Disable CcConvert")
      message("Dependency for CcConvert not enabled but required: CcKernel")
     set(CCOS_APPS_CCCONVERT_ACTIVE 0)
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
    if(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
      message("Disable CcConvert")
      message("Dependency for CcConvert not solved: CcMedia")
      set(CCOS_APPS_CCCONVERT_ACTIVE 0)
    elseif(${CCOS_CCMEDIA_ACTIVE} EQUAL 0)
      message("Disable CcConvert")
      message("Dependency for CcConvert not enabled but required: CcMedia")
     set(CCOS_APPS_CCCONVERT_ACTIVE 0)
    endif(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
  elseif(${CCOS_APPS_CCCONVERT_ACTIVE} GREATER 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message(FATAL_ERROR "Dependency for CcConvert not solved: CcKernel")
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message(FATAL_ERROR "Dependency for CcConvert not enabled but required: CcKernel")
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
    if(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
      message(FATAL_ERROR "Dependency for CcConvert not solved: CcMedia")
    elseif(${CCOS_CCMEDIA_ACTIVE} EQUAL 0)
      message(FATAL_ERROR "Dependency for CcConvert not enabled but required: CcMedia")
    endif(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
  endif(${CCOS_APPS_CCCONVERT_ACTIVE} EQUAL 1)
  # add project
  add_subdirectory("${CC_CURRENT_CONFIG_DIR}/Apps/CcConvert")
  if(DEFINED CCOS_THIRDPARTY_MTP_ACTIVE)
    if(${CCOS_THIRDPARTY_MTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "mtp not allowed on Windows")
    endif(${CCOS_THIRDPARTY_MTP_ACTIVE} GREATER 0)
...
if(GENERIC)
  ...
  if(DEFINED CCOS_APPS_CCCONVERT_ACTIVE)
    if(${CCOS_APPS_CCCONVERT_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcConvert not allowed on Generic")
    endif(${CCOS_APPS_CCCONVERT_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_APPS_CCCONVERT_ACTIVE)
  if(DEFINED CCOS_APPS_CCSHELLAPP_ACTIVE)
