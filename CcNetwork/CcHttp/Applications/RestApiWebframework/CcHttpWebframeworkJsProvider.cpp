 ...
 * @par       Language: C++11
 * @brief     Implementation of Class CcHttpWebframeworkJsProvider
 */
...
{
  Size = CcOSWebframework_Js_Length;
  return CcOSWebframework_Js;
}

const CcString& CcHttpWebframeworkJsProvider::getMimeType()
{
