...
/**
 * @page      CcHttp
 * @subpage   CcRemoteDeviceCssProvider
 *
 * @page      CcRemoteDeviceCssProvider
...
public:
   ...
   * @brief Constructor
   */
  CcRemoteDeviceCssProvider(const CcString& sCcRemoteCssPath = "/CcRemote.css") : IHttpPathContentProvider(sCcRemoteCssPath)
    {}

  /**
   * @brief Destructor
   */
  virtual ~CcRemoteDeviceCssProvider() = default;
