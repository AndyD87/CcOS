...
static const char g_Font_6x8[(144-32)*8] = {
  /* 0x20: Space ' ' */
...
CcFont::CcFont( uint16 uiFontSize ) :
 m_FontSize(uiFontSize)
{
  if(uiFontSize == 8)
  {
    m_cFontBuffer = (char*)g_Font_6x8;
    m_FontSizeX = 6;
    m_FontSizeY = 8;
  }
  else
...
char* CcFont::getPixles(char cValue)
{
  char *cRet = 0;
  uint16 pos = 0;
  if(cValue >= 0x20 )
