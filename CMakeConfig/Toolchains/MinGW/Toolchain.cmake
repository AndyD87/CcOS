if( WIN32 )
  ...
  if(${CMAKE_SYSTEM_PROCESSOR} MATCHES "86" )
    set(CMAKE_C_COMPILER            "${GCC_DIR}/${MINGW_32BIT_PATH}/mingw32/bin/gcc.exe"             CACHE INTERNAL "")
    set(CMAKE_CXX_COMPILER          "${GCC_DIR}/${MINGW_32BIT_PATH}/mingw32/bin/g++.exe"             CACHE INTERNAL "")
    set(CMAKE_MAKE_PROGRAM          "${GCC_DIR}/${MINGW_32BIT_PATH}/mingw32/bin/mingw32-make.exe"    CACHE INTERNAL "")
  ...
  elseif(${CMAKE_SYSTEM_PROCESSOR} MATCHES "32" )
    ...
    set(CMAKE_C_COMPILER            "${GCC_DIR}/${MINGW_64BIT_PATH}/mingw64/bin/gcc.exe"             CACHE INTERNAL "")
    set(CMAKE_CXX_COMPILER          "${GCC_DIR}/${MINGW_64BIT_PATH}/mingw64/bin/g++.exe"             CACHE INTERNAL "")
    set(CMAKE_MAKE_PROGRAM          "${GCC_DIR}/${MINGW_64BIT_PATH}/mingw64/bin/mingw32-make.exe"    CACHE INTERNAL "")
