...
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x64.debug.dll`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN64A --prefix=`"$PSScriptRoot\openssl.msvc140.x64.debug.dll`""
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x64.debug.static`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN64A no-shared --prefix=`"$PSScriptRoot\openssl.msvc140.x64.debug.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x64.release.dll`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN64A --prefix=`"$PSScriptRoot\openssl.msvc140.x64.release.dll`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x64.release.static`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN64A no-shared --prefix=`"$PSScriptRoot\openssl.msvc140.x64.release.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x86.debug.dll`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN32 --prefix=`"$PSScriptRoot\openssl.msvc140.x86.debug.dll`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x86.debug.static`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN32 no-shared --prefix=`"$PSScriptRoot\openssl.msvc140.x86.debug.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x86.release.dll`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN32 --prefix=`"$PSScriptRoot\openssl.msvc140.x86.release.dll`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc140.x86.release.static`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN32 no-shared --prefix=`"$PSScriptRoot\openssl.msvc140.x86.release.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
