...
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x64.debug.dll`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN64A --prefix=`"$PSScriptRoot\openssl.msvc141.x64.debug.dll`""
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x64.debug.static`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN64A no-shared --prefix=`"$PSScriptRoot\openssl.msvc141.x64.debug.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x64.release.dll`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN64A --prefix=`"$PSScriptRoot\openssl.msvc141.x64.release.dll`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" amd64'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x64.release.static`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN64A no-shared --prefix=`"$PSScriptRoot\openssl.msvc141.x64.release.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x86.debug.dll`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN32 --prefix=`"$PSScriptRoot\openssl.msvc141.x86.debug.dll`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x86.debug.static`""
Add-Content "Build.bat" "perl.exe Configure debug-VC-WIN32 no-shared --prefix=`"$PSScriptRoot\openssl.msvc141.x86.debug.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x86.release.dll`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN32 --prefix=`"$PSScriptRoot\openssl.msvc141.x86.release.dll`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
Set-Content "Build.bat" "SET PATH=%PATH%;$PSScriptRoot\StrawberryPerl\perl\bin\;$PSScriptRoot\Nasm\"
Add-Content "Build.bat" 'call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Auxiliary\Build\vcvarsall.bat" x86'
Add-Content "Build.bat" "mkdir `"$PSScriptRoot\openssl.msvc141.x86.release.static`""
Add-Content "Build.bat" "perl.exe Configure VC-WIN32 no-shared --prefix=`"$PSScriptRoot\openssl.msvc141.x86.release.static`""
Add-Content "Build.bat" "nmake"
Add-Content "Build.bat" "nmake install"
Add-Content "Build.bat" "nmake clean"
Add-Content "Build.bat" "exit"
...
cmake -E tar cf openssl.1.1.0e.msvc141.x64.zip --format=zip openssl.msvc141.x64.debug.dll openssl.msvc141.x64.debug.static openssl.msvc141.x64.release.dll openssl.msvc141.x64.release.static 
cmake -E tar cf openssl.1.1.0e.msvc141.x86.zip --format=zip openssl.msvc141.x86.debug.dll openssl.msvc141.x86.debug.static openssl.msvc141.x86.release.dll openssl.msvc141.x86.release.static 
