...
set(CMAKE_C_FLAGS           "${MCPU_FLAGS}    -specs=nosys.specs -falign-functions=4 -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -g" CACHE INTERNAL "")
set(CMAKE_CXX_FLAGS         "${CMAKE_C_FLAGS} -fno-exceptions -fno-rtti -fno-threadsafe-statics -fabi-version=0 -fno-use-cxa-atexit"  CACHE INTERNAL "")
set(CMAKE_ASM_FLAGS         "${MCPU_FLAGS}    -mcpu=${CMAKE_SYSTEM_PROCESSOR} -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16")#-fdata-sections -ffunction-sections" )
