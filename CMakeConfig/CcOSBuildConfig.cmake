...
if(WINDOWS)
  ...
  if(DEFINED CCOS_CCKERNELMODULE_ACTIVE)
    if(${CCOS_CCKERNELMODULE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcKernelModule not allowed on Windows")
...
if(LINUX)
  ...
  if(DEFINED CCOS_CCKERNELMODULE_ACTIVE)
    if(${CCOS_CCKERNELMODULE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcKernelModule not allowed on Linux")
    endif(${CCOS_CCKERNELMODULE_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCKERNELMODULE_ACTIVE)
...
if(WINDOWSKERNEL)
  ...
  if(DEFINED CCOS_CCGUI_ACTIVE)
    if(${CCOS_CCGUI_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcGui not allowed on WindowsKernel")
    endif(${CCOS_CCGUI_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCGUI_ACTIVE)
  if(DEFINED CCOS_CCMEDIA_ACTIVE)
    if(${CCOS_CCMEDIA_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcMedia not allowed on WindowsKernel")
    endif(${CCOS_CCMEDIA_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMEDIA_ACTIVE)
  if(DEFINED CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE)
    if(${CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE} GREATER 0)
      message(FATAL_ERROR "Raspbian not allowed on WindowsKernel")
    endif(${CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE)
  if(DEFINED CCOS_CCMODULES_CCTESTMODULE_ACTIVE)
    if(${CCOS_CCMODULES_CCTESTMODULE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcTestModule not allowed on WindowsKernel")
    endif(${CCOS_CCMODULES_CCTESTMODULE_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMODULES_CCTESTMODULE_ACTIVE)
  if(DEFINED CCOS_CCMODULES_CCMODULE_ACTIVE)
    if(${CCOS_CCMODULES_CCMODULE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcModule not allowed on WindowsKernel")
    endif(${CCOS_CCMODULES_CCMODULE_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMODULES_CCMODULE_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCDHCP_ACTIVE)
    if(${CCOS_CCNETWORK_CCDHCP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcDhcp not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCDHCP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCDHCP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCFTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCFTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcFtp not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCFTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCFTP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCHTTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCHTTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcHttp not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCHTTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCHTTP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE)
    if(${CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcRemoteDevice not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCSHELL_ACTIVE)
    if(${CCOS_CCNETWORK_CCSHELL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcShell not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCSHELL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCSHELL_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCSSL_ACTIVE)
    if(${CCOS_CCNETWORK_CCSSL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcSsl not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCSSL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCSSL_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCTFTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCTFTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcTftp not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCTFTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCTFTP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCMQTT_ACTIVE)
    if(${CCOS_CCNETWORK_CCMQTT_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcMqtt not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCMQTT_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCMQTT_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCMTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCMTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcMtp not allowed on WindowsKernel")
    endif(${CCOS_CCNETWORK_CCMTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCMTP_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCBITCOIN_ACTIVE)
    if(${CCOS_CCUTIL_CCBITCOIN_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcBitcoin not allowed on WindowsKernel")
    endif(${CCOS_CCUTIL_CCBITCOIN_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCBITCOIN_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCDOCUMENTS_ACTIVE)
    if(${CCOS_CCUTIL_CCDOCUMENTS_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcDocuments not allowed on WindowsKernel")
    endif(${CCOS_CCUTIL_CCDOCUMENTS_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCDOCUMENTS_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCTESTING_ACTIVE)
    if(${CCOS_CCUTIL_CCTESTING_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcTesting not allowed on WindowsKernel")
    endif(${CCOS_CCUTIL_CCTESTING_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCTESTING_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCSQL_ACTIVE)
    if(${CCOS_CCUTIL_CCSQL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcSql not allowed on WindowsKernel")
    endif(${CCOS_CCUTIL_CCSQL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCSQL_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE)
    if(${CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSBuildConfig not allowed on WindowsKernel")
    endif(${CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE)
    if(${CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcAppInterfaces not allowed on WindowsKernel")
    endif(${CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCHASH_ACTIVE)
    if(${CCOS_CCAPPS_CCHASH_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcHash not allowed on WindowsKernel")
    endif(${CCOS_CCAPPS_CCHASH_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCHASH_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE)
    if(${CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSBuildConfigApp not allowed on WindowsKernel")
    endif(${CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE)
    if(${CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcRemoteDeviceServer not allowed on WindowsKernel")
    endif(${CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE)
    if(${CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcRemoteDeviceClient not allowed on WindowsKernel")
    endif(${CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE)
    if(${CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSResourceApp not allowed on WindowsKernel")
    endif(${CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE)
    if(${CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSModuleLoader not allowed on WindowsKernel")
    endif(${CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_JPEG_ACTIVE)
    if(${CCOS_THIRDPARTY_JPEG_ACTIVE} GREATER 0)
      message(FATAL_ERROR "jpeg not allowed on WindowsKernel")
    endif(${CCOS_THIRDPARTY_JPEG_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_JPEG_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_OPENSSL_ACTIVE)
    if(${CCOS_THIRDPARTY_OPENSSL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "openssl not allowed on WindowsKernel")
    endif(${CCOS_THIRDPARTY_OPENSSL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_OPENSSL_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_MTP_ACTIVE)
    if(${CCOS_THIRDPARTY_MTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "mtp not allowed on WindowsKernel")
    endif(${CCOS_THIRDPARTY_MTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_MTP_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_SQLITE3_ACTIVE)
    if(${CCOS_THIRDPARTY_SQLITE3_ACTIVE} GREATER 0)
      message(FATAL_ERROR "sqlite3 not allowed on WindowsKernel")
    endif(${CCOS_THIRDPARTY_SQLITE3_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_SQLITE3_ACTIVE)
...
if(LINUXKERNEL)
  ...
  if(DEFINED CCOS_CCGUI_ACTIVE)
    if(${CCOS_CCGUI_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcGui not allowed on LinuxKernel")
    endif(${CCOS_CCGUI_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCGUI_ACTIVE)
  if(DEFINED CCOS_CCMEDIA_ACTIVE)
    if(${CCOS_CCMEDIA_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcMedia not allowed on LinuxKernel")
    endif(${CCOS_CCMEDIA_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMEDIA_ACTIVE)
  if(DEFINED CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE)
    if(${CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE} GREATER 0)
      message(FATAL_ERROR "Raspbian not allowed on LinuxKernel")
    endif(${CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE)
  if(DEFINED CCOS_CCMODULES_CCTESTMODULE_ACTIVE)
    if(${CCOS_CCMODULES_CCTESTMODULE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcTestModule not allowed on LinuxKernel")
    endif(${CCOS_CCMODULES_CCTESTMODULE_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMODULES_CCTESTMODULE_ACTIVE)
  if(DEFINED CCOS_CCMODULES_CCMODULE_ACTIVE)
    if(${CCOS_CCMODULES_CCMODULE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcModule not allowed on LinuxKernel")
    endif(${CCOS_CCMODULES_CCMODULE_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCMODULES_CCMODULE_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCDHCP_ACTIVE)
    if(${CCOS_CCNETWORK_CCDHCP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcDhcp not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCDHCP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCDHCP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCFTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCFTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcFtp not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCFTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCFTP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCHTTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCHTTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcHttp not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCHTTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCHTTP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE)
    if(${CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcRemoteDevice not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCREMOTEDEVICE_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCSHELL_ACTIVE)
    if(${CCOS_CCNETWORK_CCSHELL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcShell not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCSHELL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCSHELL_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCSSL_ACTIVE)
    if(${CCOS_CCNETWORK_CCSSL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcSsl not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCSSL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCSSL_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCTFTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCTFTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcTftp not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCTFTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCTFTP_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCMQTT_ACTIVE)
    if(${CCOS_CCNETWORK_CCMQTT_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcMqtt not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCMQTT_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCMQTT_ACTIVE)
  if(DEFINED CCOS_CCNETWORK_CCMTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCMTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcMtp not allowed on LinuxKernel")
    endif(${CCOS_CCNETWORK_CCMTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCNETWORK_CCMTP_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCBITCOIN_ACTIVE)
    if(${CCOS_CCUTIL_CCBITCOIN_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcBitcoin not allowed on LinuxKernel")
    endif(${CCOS_CCUTIL_CCBITCOIN_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCBITCOIN_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCDOCUMENTS_ACTIVE)
    if(${CCOS_CCUTIL_CCDOCUMENTS_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcDocuments not allowed on LinuxKernel")
    endif(${CCOS_CCUTIL_CCDOCUMENTS_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCDOCUMENTS_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCTESTING_ACTIVE)
    if(${CCOS_CCUTIL_CCTESTING_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcTesting not allowed on LinuxKernel")
    endif(${CCOS_CCUTIL_CCTESTING_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCTESTING_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCSQL_ACTIVE)
    if(${CCOS_CCUTIL_CCSQL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcSql not allowed on LinuxKernel")
    endif(${CCOS_CCUTIL_CCSQL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCSQL_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE)
    if(${CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSBuildConfig not allowed on LinuxKernel")
    endif(${CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCOSBUILDCONFIG_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE)
    if(${CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcAppInterfaces not allowed on LinuxKernel")
    endif(${CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCAPPINTERFACES_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCHASH_ACTIVE)
    if(${CCOS_CCAPPS_CCHASH_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcHash not allowed on LinuxKernel")
    endif(${CCOS_CCAPPS_CCHASH_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCHASH_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE)
    if(${CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSBuildConfigApp not allowed on LinuxKernel")
    endif(${CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE)
    if(${CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcRemoteDeviceServer not allowed on LinuxKernel")
    endif(${CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCREMOTEDEVICESERVER_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE)
    if(${CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcRemoteDeviceClient not allowed on LinuxKernel")
    endif(${CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCREMOTEDEVICECLIENT_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE)
    if(${CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSResourceApp not allowed on LinuxKernel")
    endif(${CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCOSRESOURCEAPP_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE)
    if(${CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcOSModuleLoader not allowed on LinuxKernel")
    endif(${CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_CCOSMODULELOADER_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_JPEG_ACTIVE)
    if(${CCOS_THIRDPARTY_JPEG_ACTIVE} GREATER 0)
      message(FATAL_ERROR "jpeg not allowed on LinuxKernel")
    endif(${CCOS_THIRDPARTY_JPEG_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_JPEG_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_OPENSSL_ACTIVE)
    if(${CCOS_THIRDPARTY_OPENSSL_ACTIVE} GREATER 0)
      message(FATAL_ERROR "openssl not allowed on LinuxKernel")
    endif(${CCOS_THIRDPARTY_OPENSSL_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_OPENSSL_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_MTP_ACTIVE)
    if(${CCOS_THIRDPARTY_MTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "mtp not allowed on LinuxKernel")
    endif(${CCOS_THIRDPARTY_MTP_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_MTP_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_SQLITE3_ACTIVE)
    if(${CCOS_THIRDPARTY_SQLITE3_ACTIVE} GREATER 0)
      message(FATAL_ERROR "sqlite3 not allowed on LinuxKernel")
    endif(${CCOS_THIRDPARTY_SQLITE3_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_SQLITE3_ACTIVE)
