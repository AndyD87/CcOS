...
if(WINDOWS)
  ...
  if(${CCOS_CCKERNEL_ACTIVE} EQUAL 1)
    ...
    if(DEFINED CCOS_CCAPPS_IHash_ACTIVE)
      if(${CCOS_CCAPPS_IHash_ACTIVE} GREATER 1)
        set(CCOS_CCKERNEL_ACTIVE 2)
      endif(${CCOS_CCAPPS_IHash_ACTIVE} GREATER 1)
    endif(DEFINED CCOS_CCAPPS_IHash_ACTIVE)
  ...
  # Project: IHash
  if(NOT DEFINED CCOS_CCAPPS_IHash_ACTIVE)
    set(CCOS_CCAPPS_IHash_ACTIVE 1)
  endif(NOT DEFINED CCOS_CCAPPS_IHash_ACTIVE)
  if(NOT DEFINED CCOS_CCAPPS_IHash_VERSION)
    set(CCOS_CCAPPS_IHash_VERSION 0.0.0.0)
  endif(NOT DEFINED CCOS_CCAPPS_IHash_VERSION)
  if(NOT DEFINED CCOS_CCAPPS_IHash_PREBUILD)
    set(CCOS_CCAPPS_IHash_PREBUILD false)
  endif(NOT DEFINED CCOS_CCAPPS_IHash_PREBUILD)
  if(NOT DEFINED CCOS_CCAPPS_IHash_STATIC)
    set(CCOS_CCAPPS_IHash_STATIC false)
  endif(NOT DEFINED CCOS_CCAPPS_IHash_STATIC)
  if(NOT DEFINED CCOS_CCAPPS_IHash_STATICRUNTIME)
    set(CCOS_CCAPPS_IHash_STATICRUNTIME false)
  endif(NOT DEFINED CCOS_CCAPPS_IHash_STATICRUNTIME)
  # Check if required because of income dependencies
  if(${CCOS_CCAPPS_IHash_ACTIVE} EQUAL 1)
  endif(${CCOS_CCAPPS_IHash_ACTIVE} EQUAL 1)
  # Check if required because of income dependencies
  if(${CCOS_CCAPPS_IHash_ACTIVE} EQUAL 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message("Diable IHash")
      message("Dependency for IHash not solved: CcKernel")
      set(CCOS_CCAPPS_IHash_ACTIVE 0)
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message("Diable IHash")
      message("Dependency for IHash not enabled but required: CcKernel")
     set(CCOS_CCAPPS_IHash_ACTIVE 0)
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
  elseif(${CCOS_CCAPPS_IHash_ACTIVE} GREATER 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message(FATAL_ERROR "Dependency for IHash not solved: CcKernel")
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message(FATAL_ERROR "Dependency for IHash not enabled but required: CcKernel")
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
  endif(${CCOS_CCAPPS_IHash_ACTIVE} EQUAL 1)
  if(DEFINED CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE)
    if(${CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE} GREATER 0)
...
if(GENERIC)
  ...
  if(DEFINED CCOS_CCNETWORK_CCHTTP_ACTIVE)
    if(${CCOS_CCNETWORK_CCHTTP_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcHttp not allowed on Generic")
  ...
  if(DEFINED CCOS_CCAPPS_IHash_ACTIVE)
    if(${CCOS_CCAPPS_IHash_ACTIVE} GREATER 0)
      message(FATAL_ERROR "IHash not allowed on Generic")
    endif(${CCOS_CCAPPS_IHash_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCAPPS_IHash_ACTIVE)
  if(DEFINED CCOS_CCAPPS_CCOSBUILDCONFIGAPP_ACTIVE)
