...
if(WINDOWS)
  ...
  if(${CCOS_CCKERNEL_ACTIVE} EQUAL 1)
    ...
    if(DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
      if(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 1)
        set(CCOS_CCKERNEL_ACTIVE 2)
      endif(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 1)
  ...
  if(DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
    if(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcGphoto not allowed on Windows")
    endif(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
  if(DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
    if(${CCOS_THIRDPARTY_GPHOTO2_ACTIVE} GREATER 0)
      message(FATAL_ERROR "gphoto2 not allowed on Windows")
    endif(${CCOS_THIRDPARTY_GPHOTO2_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
...
if(LINUX)
  ...
  # gphoto2
  ################################################################################
  if(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
    set(CCOS_THIRDPARTY_GPHOTO2_ACTIVE 1)
  endif(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
  if(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_VERSION)
    set(CCOS_THIRDPARTY_GPHOTO2_VERSION 2.5.22.0)
  endif(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_VERSION)
  if(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_PREBUILD)
    set(CCOS_THIRDPARTY_GPHOTO2_PREBUILD true)
  endif(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_PREBUILD)
  if(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_STATIC)
    set(CCOS_THIRDPARTY_GPHOTO2_STATIC true)
  endif(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_STATIC)
  if(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_STATICRUNTIME)
    set(CCOS_THIRDPARTY_GPHOTO2_STATICRUNTIME true)
  endif(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_STATICRUNTIME)
  # Check if required because of income dependencies
  if(${CCOS_THIRDPARTY_GPHOTO2_ACTIVE} EQUAL 1)
    if(DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
      if(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 1)
        set(CCOS_THIRDPARTY_GPHOTO2_ACTIVE 2)
      endif(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 1)
    endif(DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
  ...
  # CcGphoto
  ################################################################################
  if(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
    set(CCOS_CCUTIL_CCGPHOTO_ACTIVE 1)
  endif(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
  if(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_VERSION)
    set(CCOS_CCUTIL_CCGPHOTO_VERSION 0.0.0.0)
  endif(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_VERSION)
  if(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_PREBUILD)
    set(CCOS_CCUTIL_CCGPHOTO_PREBUILD false)
  endif(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_PREBUILD)
  if(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_STATIC)
    set(CCOS_CCUTIL_CCGPHOTO_STATIC false)
  endif(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_STATIC)
  if(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_STATICRUNTIME)
    set(CCOS_CCUTIL_CCGPHOTO_STATICRUNTIME true)
  endif(NOT DEFINED CCOS_CCUTIL_CCGPHOTO_STATICRUNTIME)
  # Check if required because of income dependencies
  if(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} EQUAL 1)
  endif(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} EQUAL 1)
  # Check if required because of own dependencies
  if(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} EQUAL 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message("Disable CcGphoto")
      message("Dependency for CcGphoto not solved: CcKernel")
      set(CCOS_CCUTIL_CCGPHOTO_ACTIVE 0)
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message("Disable CcGphoto")
      message("Dependency for CcGphoto not enabled but required: CcKernel")
     set(CCOS_CCUTIL_CCGPHOTO_ACTIVE 0)
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
    if(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
      message("Disable CcGphoto")
      message("Dependency for CcGphoto not solved: CcMedia")
      set(CCOS_CCUTIL_CCGPHOTO_ACTIVE 0)
    elseif(${CCOS_CCMEDIA_ACTIVE} EQUAL 0)
      message("Disable CcGphoto")
      message("Dependency for CcGphoto not enabled but required: CcMedia")
     set(CCOS_CCUTIL_CCGPHOTO_ACTIVE 0)
    endif(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
    if(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
      message("Disable CcGphoto")
      message("Dependency for CcGphoto not solved: gphoto2")
      set(CCOS_CCUTIL_CCGPHOTO_ACTIVE 0)
    elseif(${CCOS_THIRDPARTY_GPHOTO2_ACTIVE} EQUAL 0)
      message("Disable CcGphoto")
      message("Dependency for CcGphoto not enabled but required: gphoto2")
     set(CCOS_CCUTIL_CCGPHOTO_ACTIVE 0)
    endif(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
  elseif(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message(FATAL_ERROR "Dependency for CcGphoto not solved: CcKernel")
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message(FATAL_ERROR "Dependency for CcGphoto not enabled but required: CcKernel")
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
    if(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
      message(FATAL_ERROR "Dependency for CcGphoto not solved: CcMedia")
    elseif(${CCOS_CCMEDIA_ACTIVE} EQUAL 0)
      message(FATAL_ERROR "Dependency for CcGphoto not enabled but required: CcMedia")
    endif(NOT DEFINED CCOS_CCMEDIA_ACTIVE)
    if(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
      message(FATAL_ERROR "Dependency for CcGphoto not solved: gphoto2")
    elseif(${CCOS_THIRDPARTY_GPHOTO2_ACTIVE} EQUAL 0)
      message(FATAL_ERROR "Dependency for CcGphoto not enabled but required: gphoto2")
    endif(NOT DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
  endif(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} EQUAL 1)
  # add project
...
if(GENERIC)
  ...
  if(DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
    if(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 0)
      message(FATAL_ERROR "CcGphoto not allowed on Generic")
    endif(${CCOS_CCUTIL_CCGPHOTO_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_CCUTIL_CCGPHOTO_ACTIVE)
  if(DEFINED CCOS_CCUTIL_CCSQL_ACTIVE)
  ...
  if(DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
    if(${CCOS_THIRDPARTY_GPHOTO2_ACTIVE} GREATER 0)
      message(FATAL_ERROR "gphoto2 not allowed on Generic")
    endif(${CCOS_THIRDPARTY_GPHOTO2_ACTIVE} GREATER 0)
  endif(DEFINED CCOS_THIRDPARTY_GPHOTO2_ACTIVE)
