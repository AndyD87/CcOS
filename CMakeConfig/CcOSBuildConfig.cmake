...
if(WINDOWS)
  ...
  if(${CCOS_CCKERNEL_ACTIVE} EQUAL 1)
    ...
    if(DEFINED CCOS_CCMODULES_CCMODULE_ACTIVE)
      if(${CCOS_CCMODULES_CCMODULE_ACTIVE} GREATER 1)
        set(CCOS_CCKERNEL_ACTIVE 2)
      endif(${CCOS_CCMODULES_CCMODULE_ACTIVE} GREATER 1)
  ...
  if(${CCOS_CCMODULES_CCMODULE_ACTIVE} EQUAL 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message("Disable CcModule")
      message("Dependency for CcModule not solved: CcKernel")
      set(CCOS_CCMODULES_CCMODULE_ACTIVE 0)
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message("Disable CcModule")
      message("Dependency for CcModule not enabled but required: CcKernel")
     set(CCOS_CCMODULES_CCMODULE_ACTIVE 0)
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
  elseif(${CCOS_CCMODULES_CCMODULE_ACTIVE} GREATER 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message(FATAL_ERROR "Dependency for CcModule not solved: CcKernel")
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message(FATAL_ERROR "Dependency for CcModule not enabled but required: CcKernel")
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
  endif(${CCOS_CCMODULES_CCMODULE_ACTIVE} EQUAL 1)
  # add project
