...
if(WINDOWS)
  ...
  if(${CCOS_CCMODULES_CCMODULE_ACTIVE} EQUAL 1)
    ...
    if(DEFINED CCOS_CCAPPS_CCDHCPSERVER_ACTIVE)
      if(${CCOS_CCAPPS_CCDHCPSERVER_ACTIVE} GREATER 1)
        set(CCOS_CCMODULES_CCMODULE_ACTIVE 2)
      endif(${CCOS_CCAPPS_CCDHCPSERVER_ACTIVE} GREATER 1)
    endif(DEFINED CCOS_CCAPPS_CCDHCPSERVER_ACTIVE)
  ...
  # CcDhcpServer
  ################################################################################
  if(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_ACTIVE)
    set(CCOS_CCAPPS_CCDHCPSERVER_ACTIVE 1)
  endif(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_ACTIVE)
  if(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_VERSION)
    set(CCOS_CCAPPS_CCDHCPSERVER_VERSION 0.0.0.0)
  endif(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_VERSION)
  if(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_PREBUILD)
    set(CCOS_CCAPPS_CCDHCPSERVER_PREBUILD false)
  endif(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_PREBUILD)
  if(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_STATIC)
    set(CCOS_CCAPPS_CCDHCPSERVER_STATIC false)
  endif(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_STATIC)
  if(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_STATICRUNTIME)
    set(CCOS_CCAPPS_CCDHCPSERVER_STATICRUNTIME false)
  endif(NOT DEFINED CCOS_CCAPPS_CCDHCPSERVER_STATICRUNTIME)
  # Check if required because of income dependencies
  if(${CCOS_CCAPPS_CCDHCPSERVER_ACTIVE} EQUAL 1)
  endif(${CCOS_CCAPPS_CCDHCPSERVER_ACTIVE} EQUAL 1)
  # Check if required because of own dependencies
  if(${CCOS_CCAPPS_CCDHCPSERVER_ACTIVE} EQUAL 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
      message("Disable CcDhcpServer")
      message("Dependency for CcDhcpServer not solved: CcKernel")
      set(CCOS_CCAPPS_CCDHCPSERVER_ACTIVE 0)
    elseif(${CCOS_CCKERNEL_ACTIVE} EQUAL 0)
      message("Disable CcDhcpServer")
      message("Dependency for CcDhcpServer not enabled but required: CcKernel")
     set(CCOS_CCAPPS_CCDHCPSERVER_ACTIVE 0)
    endif(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
  elseif(${CCOS_CCAPPS_CCDHCPSERVER_ACTIVE} GREATER 1)
    if(NOT DEFINED CCOS_CCKERNEL_ACTIVE)
  ...
  # add project
  add_subdirectory("${CC_CURRENT_CONFIG_DIR}/CcApps/CcDhcpServer")
  if(DEFINED CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE)
    if(${CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE} GREATER 0)
      message(FATAL_ERROR "Raspbian not allowed on Windows")
    endif(${CCOS_CCMODULES_PLATFORM_RASPBIAN_ACTIVE} GREATER 0)
